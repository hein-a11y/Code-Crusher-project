...
// }
       ...
       $sql = $pdo->prepare('INSERT INTO gg_users(login_name, firstname, firstname_kana, lastname, lastname_kana, postalcode, address, phone_number, mailaddress, password, gender, birthday)  VALUES (?,?,?,?,?,?,?,?,?,?,?,?)');
        $sql->execute([
             h($_REQUEST['login_name']),
             h($_REQUEST['firstname']),
             h($firstname_kana),
