...
if (empty($_SESSION['user_id'])) {
    // ログインページに強制的に移動させる
    header('Location: login.php'); // login.phpはご自身の環境に合わせてください
    exit();
}
...
header('Location: cart.php'); // cart.php はご自身のカートページのファイル名
exit();
