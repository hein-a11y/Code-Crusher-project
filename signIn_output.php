...
if(empty($sql->fetchAll())){
    if(isset($_SESSION['customer'])){
        ...
        $sql = $pdo->prepare('UPDATE gg_users SET login_name=?, firstname = ?, firstname_kana=?, lastname = ? lastname_kana = ?, postalcode = ?, address = ?, phone_number = ?, mailaddress = ?, password = ?, gender = ?, birthday = ?,WHERE id =?');
        $sql->execute([
